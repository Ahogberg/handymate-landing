...
const hero = src.slice(src.indexOf('<header class="lansering"'), src.indexOf('</header>'))
...
ok('heroet flippar automatiskt till live', src.includes('function visaLive()') && src.includes('hero.classList.add(\'live\')'))
ok('teamet är gråskalat före lansering och färgat efter',
  src.includes('filter:grayscale(1)') && src.includes('.live .team-kort img{filter:none}'))
...
ok('inget löfte om autonom kundkontakt — teamet förbereder, du godkänner',
